 ...
 * bitácora adicional. En hosting serverless de solo lectura esta escritura
 * puede fallar — se captura el error y se hace fallback a consola, para
 * nunca romper la respuesta al usuario por esto.
 */
