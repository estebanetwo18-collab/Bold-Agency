...
export const system = {
  ...
  intro: "Sete frentes, um mesmo time por trás de todas.",
  prevAriaLabel: "Serviço anterior",
  nextAriaLabel: "Próximo serviço",
  pillars: [
    {
      index: "01",
...
export const portfolioPage = {
  ...
  behanceEyebrow: "Portfólio visual completo",
  behanceHeadline: "Cada peça, com mais detalhes no Behance.",
  behanceCtaLabel: "Ver no Behance",
};
