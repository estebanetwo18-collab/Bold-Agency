...
export const system = {
  ...
  intro: "Seven fronts, one team behind all of them.",
...
export const portfolioPage = {
  ...
  behanceEyebrow: "Full visual portfolio",
  behanceHeadline: "Every piece, in more detail on Behance.",
  behanceCtaLabel: "View on Behance",
};
